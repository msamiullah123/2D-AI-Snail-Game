    ...
    def on_key_press(self,key,modifiers):
        ...
        if self.switch == 2:
            if key == arcade.key.W:
                ...
                if (self.row1+1, self.col1) not in self.restricted_p2 and (self.row1+1, self.col1) != (self.row2,self.col2):
            ...
            if key == arcade.key.A:
                arcade.play_sound(laser_sound)
                if (self.row1, self.col1-1) not in self.restricted_p2 and (self.row1, self.col1-1) != (self.row2,self.col2):
                    self.restricted_p1.append((self.row1, self.col1))
                    self.Splash(self.player_sprite.center_x, self.player_sprite.center_y)
                    self.switch = 11
                    self.score += 1
        ...
        if self.switch == 1:
            if key == arcade.key.UP:
                ...
                if (self.row2+1, self.col2) not in self.restricted_p1 and (self.row2+1, self.col2) != (self.row1,self.col1) :
            ...
            if key == arcade.key.LEFT:
                arcade.play_sound(impact_sound)
                if (self.row2, self.col2-1) not in self.restricted_p1 and (self.row2, self.col2-1) != (self.row1,self.col1):
                    self.restricted_p2.append((self.row2, self.col2))
                    self.Splash2(self.player_2.center_x, self.player_2.center_y)
                    self.switch = 22
                return 0
