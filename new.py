...
class GameView(arcade.View):
    ...
    def on_key_press(self, key, modifiers):
        ...
        while yy != 645:
            ...
            zz[1]=yy
            loop=tuple(zz)
            if (loop not in self.player2_list) and (loop not in self.player1_list):
                up_bot+=1
            else:
                yy=645
        loop=self.temp_bot
            
        check_list.append(up_bot)
        ...
        while xx != 640:
            ...
            if (loop not in self.player2_list) and (loop not in self.player1_list):
                ...
                xx=640
        loop=self.temp_bot
        print("rightscore",right_bot)
            
        check_list.append(right_bot)
        ...
        check_list.append(left_bot)
        
        print("score",check_list)
        get_max=max(check_list)
        index1=check_list.index(get_max)
        print(index1)
        check_list.clear
        up_bot=0
        down_bot=0
